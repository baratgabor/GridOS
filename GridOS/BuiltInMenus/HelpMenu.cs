...
namespace IngameScript
{
    partial class Program
    {
        ...
        /// </summary>
        class HelpMenu : DisplayGroup
        {
            private DisplayElement _helpTextGeneric = new DisplayElement($"Welcome to GridOS!{Environment.NewLine}{Environment.NewLine}GridOS is a modular multitasking system with flexible menu display capabilities.{Environment.NewLine}{Environment.NewLine}The following subpages will help you to understand the usage of GridOS:{Environment.NewLine}");

            private DisplayGroup _moreInfo_Modules = new DisplayGroup("Modules");
            private DisplayGroup _moreInfo_AutoUpdates = new DisplayGroup("Auto-Updates");
            private DisplayGroup _moreInfo_Commands = new DisplayGroup("Commands");
            private DisplayGroup _moreInfo_Menus = new DisplayGroup($"Menus");

            private DisplayElement _helpText_Commands = new DisplayElement($"About commands:{Environment.NewLine}{Environment.NewLine}Each module can register multiple commands in GridOS.{Environment.NewLine}{Environment.NewLine}These commands can be executed by supplying their name to the programmable block as a parameter.{Environment.NewLine}{Environment.NewLine}Besides these, there are some built-in commands in GridOS, for example for registering LCDs, and enabling and disabling the automatic updates.{Environment.NewLine}{Environment.NewLine}You can find the list of all available commands in the Status menu.{Environment.NewLine}{Environment.NewLine}This command list dynamically updates, and always shows the actually available commands at a given moment.{Environment.NewLine}");
